...
// httpdocs/components/post-list.js
var PostList = class extends HTMLElement {
  constructor() {
    super();
    this.posts = [];
  }
  ...
  render() {
    const postsHTML = this.posts.map(
      (post) => `
...
// httpdocs/components/post-viewer.js
var PostViewer = class extends HTMLElement {
  constructor() {
    super();
  ...
  render() {
    this.innerHTML = `
      <div class="post-viewer">
        <button class="post-close" aria-label="Cerrar post">\xD7</button>
